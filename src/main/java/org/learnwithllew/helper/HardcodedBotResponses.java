...
public class HardcodedBotResponses {
    ...
    public static final SendQuestionCommand ACKNOWLEDGE_INTENT_AND_ARE_YOU_A_CUSTOMER_QUERY = new SendQuestionCommand("I'd be happy to help you with this, But first, I need to know: are you a customer?", "Yes, I'm a customer", "No, I'm not");
